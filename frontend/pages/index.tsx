...
import { SortSelector, SortButton } from "../components/styled/SortSelector.styled";
...
const Home: NextPage = () => {
  ...
  return (
    <Container>
      ...
      <SortSelector>
        <SortButton selected={sorting == ideaSorting.best} onClick = {() => {_setSorting(ideaSorting.best)}}><MdThumbUp></MdThumbUp><span>Melhores</span></SortButton>

        <SortButton selected={sorting == ideaSorting.worst} onClick = {() => {_setSorting(ideaSorting.worst)}}><MdThumbDown></MdThumbDown><span>Piores</span></SortButton>

        <SortButton selected={sorting == ideaSorting.latest} onClick = {() => {_setSorting(ideaSorting.latest)}}> <MdHourglassBottom></MdHourglassBottom><span>Mais Recentes</span></SortButton>
      </SortSelector>
      <IdeasContainer>
